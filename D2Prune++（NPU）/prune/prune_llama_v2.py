...
class D2Prune_LLAMA:
    ...
    def _compute_local_bounds(self, global_sparsity, layer_idx, num_layers, r_min, r_max):
        ...
        # Original bandwidth
        base_band = max(0.10, 0.30 * min(gs, 1.0 - gs))  # Slightly relaxed, 0.1-0.15
        if num_layers <= 1:
            scale = 1.0
        else:
        ...
        def prune_and_loss(current_r, X, Y, seed_for_all):
            ...
            for i, name in enumerate(subset_copy):
                ...
                try:
                    ...
                    # Once pruning internally throws error (including NaN/Inf), directly return huge loss to avoid polluting this round's estimation
        ...
        for i in tqdm(range(len(self.layers)), desc='Pruning Processing'):
            ...
            if self.args.dsm == 'owl':
                ...
                if self.args.free:
                    ...
                    torch.cuda.empty_cache()
            elif self.args.dsm == 'mezo': # Get sparsity layer by layer
