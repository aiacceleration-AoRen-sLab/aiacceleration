...
sh scripts/pangu_v1.sh

sh scripts/pangu_v1.1.sh
...
Based on the original d2prune, you only need to change d2_sparsegpt to d2_admm (added a beta parameter, default is 0.9), the q/k/v configuration is consistent with d2prune
...
For LLaMA-2/3 series models (set according to your GPU memory size), you can add the --free parameter to offload GPU
